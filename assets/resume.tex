...
\begin{itemize}
  \item Performed denoising on the DMCC55B Open fMRI dataset (AX-CPT, Cued Task Switching, Sternberg Working Memory, Stroop) following the Ciric et al. (2017) pipeline and synchronized cross-subject temporal variability using BrainSync (Akrami et al. (2019)) (MATLAB).
