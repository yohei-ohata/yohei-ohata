...
\textbf{Research Scientist} \hfill January 2026 -- Present \\ 
National Institute of Information and Communications Technology \\ 
{\small {Laboratory: Computational Neuroscience \& Decision Making Laboratory}} \\ 
{\small \textit{Supervisor: Haruno Masahiko}} \\ 
\begin{itemize}
  \item Investigated brain decoding foundation models incorporating attention mechanisms and VQ-VAE, while exploring latent variable frameworks such as CEBRA and FINDR for neural data analysis
\end{itemize}
\vspace{8pt}
...
\begin{itemize}
  \item Performed denoising on the DMCC55B Open fMRI dataset following the Ciric et al. (2017) pipeline and synchronized cross-subject temporal variability using BrainSync (MATLAB).
  ...
  \item Quantified performance by indexing RT and Accuracy via the Cognitive Control Index (CCI), extracting contributory components using dCRT with d0 statistics (R).
  \item Evaluated spatial map similarity across cognitive tasks using t-SNE, ISOMAP, UMAP and feature selection via Nested Cross-Validation LASSO (Python).
\end{itemize}
\vspace{8pt}
...
\begin{itemize}
  \item Proposed a Composite Hilbert Transform that integrates a pre-normalized notch filter to suppress noise at specific frequencies.
...
\textbf{Research Scientist} \hfill April 2024 -- December 2025 \\ 
